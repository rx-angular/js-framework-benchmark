...
import { mouseEvent, inputEvent, focusEvent, formControlsEvents } from './event-names';
import {getZoneUnPatchedApi} from "../for/util/default.strategies";
...
export class UnpatchEventsDirective implements AfterViewInit, OnDestroy {
  ...
  reapplyEventListenersZoneUnPatched(events: any[]) {
    events.forEach((ev) => {
