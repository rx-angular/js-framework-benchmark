...
function siftUp(heap: any[], node: ReactSchedulerTask, i: number) {
  let index = i;
  while (true) {
...
// tslint:disable
function siftDown(heap: any[], node: ReactSchedulerTask, i: number) {
  let index = i;
...
function compare(a: { sortIndex: number; id: number; }, b: ReactSchedulerTask) {
