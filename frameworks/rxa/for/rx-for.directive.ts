...
import {createListManager, ListManager,} from './util/list-manager';
...
import {RX_PRIMARY_STRATEGY} from "../default-primary-strategy-token";
...
export class RxFor<T, U extends NgIterable<T> = NgIterable<T>>
    ...
    ngOnInit() {
        ...
        this.listManager = createListManager<T, RxForViewContext<T>>({
            ...
            defaultStrategyName: this.defaultStrategy || 'local',
